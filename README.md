...
-   Html script tag, see [releases](https://github.com/ROXE/roxejs-ecc/releases) for the correct **version** and its matching script **integrity** hash.
...
<head>
  ...
  -->
  <script src="https://cdn.jsdelivr.net/npm/roxejs-ecc@4.0.4/lib/roxejs-ecc.min.js"
...
```bash
git clone https://github.com/ROXE/roxejs-ecc.git
cd roxejs-ecc
yarn
yarn build_browser
